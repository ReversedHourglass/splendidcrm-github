...
print 'TERMINOLOGY Reports en-us';
GO
...
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_ATTACHMENT_BUTTON_LABEL'                   , N'en-US', N'Reports', null, null, N'Send as Attachment';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_ATTACHMENT_BUTTON_TITLE'                   , N'en-US', N'Reports', null, null, N'Send as Attachment';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_AVAILABLE_COLUMNS'                         , N'en-US', N'Reports', null, null, N'Available Columns';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_CHOOSE_COLUMNS'                            , N'en-US', N'Reports', null, null, N'Choose Columns:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_CREATE_BUTTON_LABEL'                       , N'en-US', N'Reports', null, null, N'Create Custom Report';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_DISPLAY_COLUMNS'                           , N'en-US', N'Reports', null, null, N'Display Columns';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_DISPLAY_COLUMNS_REQUIRED'                  , N'en-US', N'Reports', null, null, N'Display Columns Required';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_FILTERS'                                   , N'en-US', N'Reports', null, null, N'Filters:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_IMPORT_BUTTON_LABEL'                       , N'en-US', N'Reports', null, null, N'Import';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_IMPORT_BUTTON_TITLE'                       , N'en-US', N'Reports', null, null, N'Import';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_FORM_TITLE'                           , N'en-US', N'Reports', null, null, N'Report List';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_MODULE_NAME'                          , N'en-US', N'Reports', null, null, N'Module Name';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_NAME'                                 , N'en-US', N'Reports', null, null, N'Name';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_PUBLISHED'                            , N'en-US', N'Reports', null, null, N'Published';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_RDL'                                  , N'en-US', N'Reports', null, null, N'Rdl';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_REPORT_NAME'                          , N'en-US', N'Reports', null, null, N'Report Name';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_REPORT_TYPE'                          , N'en-US', N'Reports', null, null, N'Report Type';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_SCHEDULE_LAST_RUN'                    , N'en-US', N'Reports', null, null, N'Last Run';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_SCHEDULE_REPORT'                      , N'en-US', N'Reports', null, null, N'Schedule Report';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_MODULE_NAME'                               , N'en-US', N'Reports', null, null, N'Module Name:';
-- 06/04/2015 Paul.  Add module abbreviation. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_MODULE_ABBREVIATION'                       , N'en-US', N'Reports', null, null, N'Rpt';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_NAME'                                      , N'en-US', N'Reports', null, null, N'Name:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_PRINT_BUTTON_LABEL'                        , N'en-US', N'Reports', null, null, N'Print as PDF';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_PRINT_BUTTON_TITLE'                        , N'en-US', N'Reports', null, null, N'Print as PDF';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_PUBLISHED'                                 , N'en-US', N'Reports', null, null, N'Published:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_RDL'                                       , N'en-US', N'Reports', null, null, N'Rdl:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_RELATED'                                   , N'en-US', N'Reports', null, null, N'Related:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REMOVE_BUTTON_LABEL'                       , N'en-US', N'Reports', null, null, N'Remove';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REMOVE_BUTTON_TITLE'                       , N'en-US', N'Reports', null, null, N'Remove';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REPORT_DASHLET'                            , N'en-US', N'Reports', null, null, N'Report Dashlet';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REPORT_NAME'                               , N'en-US', N'Reports', null, null, N'Report Name:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REPORT_TYPE'                               , N'en-US', N'Reports', null, null, N'Report Type:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_RUN_BUTTON_LABEL'                          , N'en-US', N'Reports', null, null, N'Run Report';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_RUN_BUTTON_TITLE'                          , N'en-US', N'Reports', null, null, N'Run Report';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SAVE_BUTTON_LABEL'                         , N'en-US', N'Reports', null, null, N'Save';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SAVE_BUTTON_TITLE'                         , N'en-US', N'Reports', null, null, N'Save';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SCHEDULED_REPORT'                          , N'en-US', N'Reports', null, null, N'{0} Scheduled Report';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SHOW_QUERY'                                , N'en-US', N'Reports', null, null, N'Show Query:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_WIZARD_STEP1'                              , N'en-US', N'Reports', null, null, N'1. Module';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_WIZARD_STEP2'                              , N'en-US', N'Reports', null, null, N'2. Filter';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_WIZARD_STEP3'                              , N'en-US', N'Reports', null, null, N'3. Group';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_WIZARD_STEP4'                              , N'en-US', N'Reports', null, null, N'4. Columns';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_WIZARD_STEP5'                              , N'en-US', N'Reports', null, null, N'5. Chart Options';
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_ADD_DASHLET'                               , N'en-US', N'Reports', null, null, N'Add Dashlet';
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_PUBLISH'                                   , N'en-US', N'Reports', null, null, N'Publish';
-- 09/15/2014 Paul.  Change to just Reports to match all other modules. 
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_REPORTS'                                   , N'en-US', N'Reports', null, null, N'Reports';
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_SCHEDULE'                                  , N'en-US', N'Reports', null, null, N'Schedule';
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_UNPUBLISH'                                 , N'en-US', N'Reports', null, null, N'Unpublish';
exec dbo.spTERMINOLOGY_InsertOnly N'LNK_VIEW'                                      , N'en-US', N'Reports', null, null, N'View';
-- 10/28/2011 Paul.  New tabs for report editing. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_TABS_FILTERS'                              , N'en-US', N'Reports', null, null, N'Filters';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_TABS_COLUMNS'                              , N'en-US', N'Reports', null, null, N'Columns';
-- 01/24/2012 Paul.  Missing terms. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_EXPORT'                                    , N'en-US', N'Reports', null, null, N'Export';
-- 09/19/2012 Paul.  New export terms. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_EXPORT_RDL'                                , N'en-US', N'Reports', null, null, N'Export RDL';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_EXPORT_SQL'                                , N'en-US', N'Reports', null, null, N'Export SQL';

-- 10/28/2014 Paul.  Use terminology instead of hard-coded labels. 
-- 06/09/2021 Paul.  Should specify Reports module instead of WorkflowAlertShells.  This is for React QueryBuilder. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_REPORT_ID'                            , N'en-US', N'Reports', null, null, N'Report ID';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_NAME'                                 , N'en-US', N'Reports', null, null, N'Name';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_PARAMETERS'                           , N'en-US', N'Reports', null, null, N'Parameters';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_RENDER_FORMAT'                        , N'en-US', N'Reports', null, null, N'Render Format';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REPORT_NAME'                               , N'en-US', N'Reports', null, null, N'Report Name:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_REPORT_PARAMETERS'                         , N'en-US', N'Reports', null, null, N'Report Parameters:';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_RENDER_FORMAT'                             , N'en-US', N'Reports', null, null, N'Render Format:';

exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_MODULE_NAME'                          , N'en-US', N'Reports', null, null, N'Module';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_DATA_FIELD'                           , N'en-US', N'Reports', null, null, N'Field';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_DATA_TYPE'                            , N'en-US', N'Reports', null, null, N'Type';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_OPERATOR'                             , N'en-US', N'Reports', null, null, N'Operator';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_LIST_SEARCH_TEXT'                          , N'en-US', N'Reports', null, null, N'Search';

exec dbo.spTERMINOLOGY_InsertOnly N'PDF'                                           , N'en-US', null, N'report_render_format',  1, N'PDF';
exec dbo.spTERMINOLOGY_InsertOnly N'Excel'                                         , N'en-US', null, N'report_render_format',  2, N'Excel';
exec dbo.spTERMINOLOGY_InsertOnly N'Word'                                          , N'en-US', null, N'report_render_format',  3, N'Word';
exec dbo.spTERMINOLOGY_InsertOnly N'Image'                                         , N'en-US', null, N'report_render_format',  4, N'Image';

-- 05/06/2018 Paul.  Allow button argument to specify render format so that we generate Excel attachment. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SEND_AS_PDF_BUTTON'                        , N'en-US', N'Reports', null, null, N'Send as PDF';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SEND_AS_EXCEL_BUTTON'                      , N'en-US', N'Reports', null, null, N'Send as Excel';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SEND_AS_WORD_BUTTON'                       , N'en-US', N'Reports', null, null, N'Send as Word';
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_SEND_AS_IMAGE_BUTTON'                      , N'en-US', N'Reports', null, null, N'Send as Image';
-- 05/26/2019 Paul.  All modules should have a LBL_NEW_FORM_TITLE for the React client. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_NEW_FORM_TITLE'                            , N'en-US', N'Reports', null, null, N'Reports';
-- 02/12/2021 Paul.  Provide a way to require submit before running report. 
exec dbo.spTERMINOLOGY_InsertOnly N'LBL_PRESS_SUBMIT_TO_RUN'                       , N'en-US', N'Reports', null, null, N'Press Submit to run the report.';
GO
...
BEGIN
-- #endif Oracle */
exec dbo.spTERMINOLOGY_InsertOnly N'Reports'                                       , N'en-US', null, N'moduleList'                        ,  39, N'Reports';
...
exec dbo.spTERMINOLOGY_InsertOnly N'not_contains'                                  , N'en-US', null, N'ansistring_operator_dom'           ,   8, N'Does Not Contain';
exec dbo.spTERMINOLOGY_InsertOnly N'not_starts_with'                               , N'en-US', null, N'ansistring_operator_dom'           ,   9, N'Does Not Start With';
exec dbo.spTERMINOLOGY_InsertOnly N'not_ends_with'                                 , N'en-US', null, N'ansistring_operator_dom'           ,  10, N'Does Not End With';
-- 02/14/2013 Paul.  A customer wants to use like in string filters. 
exec dbo.spTERMINOLOGY_InsertOnly N'like'                                          , N'en-US', null, N'ansistring_operator_dom'           ,  11, N'Like';
exec dbo.spTERMINOLOGY_InsertOnly N'not_like'                                      , N'en-US', null, N'ansistring_operator_dom'           ,  12, N'Not Like';
-- 07/23/2013 Paul.  Add greater and less than conditions. 
exec dbo.spTERMINOLOGY_InsertOnly N'less'                                          , N'en-US', null, N'ansistring_operator_dom'           ,  13, N'Less Than';
exec dbo.spTERMINOLOGY_InsertOnly N'less_equal'                                    , N'en-US', null, N'ansistring_operator_dom'           ,  14, N'Less Than or Equal';
exec dbo.spTERMINOLOGY_InsertOnly N'greater'                                       , N'en-US', null, N'ansistring_operator_dom'           ,  15, N'Greater Than';
exec dbo.spTERMINOLOGY_InsertOnly N'greater_equal'                                 , N'en-US', null, N'ansistring_operator_dom'           ,  16, N'Greater Than or Equal';
...
-- 07/23/2013 Paul.  Add greater and less than conditions. 
exec dbo.spTERMINOLOGY_InsertOnly N'less_equal'                                    , N'en-US', null, N'decimal_operator_dom'              ,   8, N'Less Than or Equal';
exec dbo.spTERMINOLOGY_InsertOnly N'greater_equal'                                 , N'en-US', null, N'decimal_operator_dom'              ,   9, N'Greater Than or Equal';
...
-- 07/23/2013 Paul.  Add greater and less than conditions. 
exec dbo.spTERMINOLOGY_InsertOnly N'less_equal'                                    , N'en-US', null, N'float_operator_dom'                ,   8, N'Less Than or Equal';
exec dbo.spTERMINOLOGY_InsertOnly N'greater_equal'                                 , N'en-US', null, N'float_operator_dom'                ,   9, N'Greater Than or Equal';
...
-- 07/23/2013 Paul.  Add greater and less than conditions. 
exec dbo.spTERMINOLOGY_InsertOnly N'less_equal'                                    , N'en-US', null, N'int32_operator_dom'                ,   8, N'Less Than or Equal';
exec dbo.spTERMINOLOGY_InsertOnly N'greater_equal'                                 , N'en-US', null, N'int32_operator_dom'                ,   9, N'Greater Than or Equal';
...
-- 08/25/2011 Paul.  A customer wants more use of NOT in string filters. 
exec dbo.spTERMINOLOGY_InsertOnly N'not_contains'                                  , N'en-US', null, N'string_operator_dom'               ,   8, N'Does Not Contain';
exec dbo.spTERMINOLOGY_InsertOnly N'not_starts_with'                               , N'en-US', null, N'string_operator_dom'               ,   9, N'Does Not Start With';
exec dbo.spTERMINOLOGY_InsertOnly N'not_ends_with'                                 , N'en-US', null, N'string_operator_dom'               ,  10, N'Does Not End With';
-- 02/14/2013 Paul.  A customer wants to use like in string filters. 
exec dbo.spTERMINOLOGY_InsertOnly N'like'                                          , N'en-US', null, N'string_operator_dom'               ,  11, N'Like';
exec dbo.spTERMINOLOGY_InsertOnly N'not_like'                                      , N'en-US', null, N'string_operator_dom'               ,  12, N'Not Like';
-- 07/23/2013 Paul.  Add greater and less than conditions. 
exec dbo.spTERMINOLOGY_InsertOnly N'less'                                          , N'en-US', null, N'string_operator_dom'               ,  13, N'Less Than';
exec dbo.spTERMINOLOGY_InsertOnly N'less_equal'                                    , N'en-US', null, N'string_operator_dom'               ,  14, N'Less Than or Equal';
exec dbo.spTERMINOLOGY_InsertOnly N'greater'                                       , N'en-US', null, N'string_operator_dom'               ,  15, N'Greater Than';
exec dbo.spTERMINOLOGY_InsertOnly N'greater_equal'                                 , N'en-US', null, N'string_operator_dom'               ,  16, N'Greater Than or Equal';
GO

-- 03/06/2012 Paul.  Date Rules are used by the report parameter filters. 
-- select * from TERMINOLOGY where LIST_NAME = 'date_rule_dom' order by LIST_ORDER;
-- delete from TERMINOLOGY where LIST_NAME = 'date_rule_dom';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(-1)'                                , N'en-US', null, N'date_rule_dom'             ,   1, N'Yesterday';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today'                                            , N'en-US', null, N'date_rule_dom'             ,   2, N'Today';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(1)'                                 , N'en-US', null, N'date_rule_dom'             ,   3, N'Tomorrow';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(-7)'                                , N'en-US', null, N'date_rule_dom'             ,   4, N'Last 7 Days';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(7)'                                 , N'en-US', null, N'date_rule_dom'             ,   5, N'Next 7 Days';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(1-DateTime.Today.Day).AddMonths(-1)', N'en-US', null, N'date_rule_dom'             ,   6, N'Last Month';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(1-DateTime.Today.Day)'              , N'en-US', null, N'date_rule_dom'             ,   7, N'This Month';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(1-DateTime.Today.Day).AddMonths(1)' , N'en-US', null, N'date_rule_dom'             ,   8, N'Next Month';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(-30)'                               , N'en-US', null, N'date_rule_dom'             ,   9, N'Last 30 Days';
exec dbo.spTERMINOLOGY_InsertOnly N'=DateTime.Today.AddDays(30)'                                , N'en-US', null, N'date_rule_dom'             ,  10, N'Next 30 Days';
exec dbo.spTERMINOLOGY_InsertOnly N'=new DateTime(DateTime.Today.Year-1, 1, 1)'                 , N'en-US', null, N'date_rule_dom'             ,  11, N'Last Year';
exec dbo.spTERMINOLOGY_InsertOnly N'=new DateTime(DateTime.Today.Year, 1, 1)'                   , N'en-US', null, N'date_rule_dom'             ,  12, N'This Year';
exec dbo.spTERMINOLOGY_InsertOnly N'=new DateTime(DateTime.Today.Year+1, 1, 1)'                 , N'en-US', null, N'date_rule_dom'             ,  13, N'Next Year';
GO
...
call dbo.spTERMINOLOGY_Reports_en_us()
/

call dbo.spSqlDropProcedure('spTERMINOLOGY_Reports_en_us')
/
-- #endif IBM_DB2 */
