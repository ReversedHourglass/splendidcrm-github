<%@ Control CodeBehind="MyTeamAccounts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.MyTeamAccounts" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divAccountsMyAccounts">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Accounts.LBL_LIST_MY_TEAM_ACCOUNTS" DivEditName="my_accounts_edit" Runat="Server" />
