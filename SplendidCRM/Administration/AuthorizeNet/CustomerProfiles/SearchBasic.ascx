<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Administration.AuthorizeNet.CustomerProfiles.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table Width="100%" CellPadding="0" CellSpacing="0" runat="server">
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel" Wrap="false"><%= L10n.Term("AuthorizeNet.LBL_EMAIL") %></asp:TableCell>
						<asp:TableCell CssClass="dataField" Wrap="false"><asp:TextBox ID="txtEMAIL" TabIndex="6" Runat="Server" /></asp:TableCell>
					</asp:TableRow>
				</asp:Table>
