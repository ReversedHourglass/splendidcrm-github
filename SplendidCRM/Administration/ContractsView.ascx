<%@ Control CodeBehind="ContractsView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Administration.ContractsView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divContractsView" visible='<%# SplendidCRM.Security.AdminUserAccess("ContractTypes", "access") >= 0 %>' runat="server">
	...
	<asp:Table Width="100%" CssClass="tabDetailView2" runat="server">
		<asp:TableRow>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2">
				<asp:Image SkinID="Contracts" AlternateText='<%# L10n.Term("Administration.LBL_CONTRACT_TYPES_TITLE") %>' Runat="server" />
				&nbsp;
			...
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2"><asp:Label Text='<%# L10n.Term("Administration.LBL_CONTRACT_TYPES_DESC") %>' runat="server" /></asp:TableCell>
