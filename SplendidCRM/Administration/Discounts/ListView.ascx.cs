...
namespace SplendidCRM.Administration.Discounts
{
	...
	public class ListView : SplendidControl
	{
		...
		protected void Page_Command(object sender, CommandEventArgs e)
		{
			try
			{
				if ( e.CommandName == "Discounts.Create" )
				{
					Response.Redirect("edit.aspx");
				}
				else if ( e.CommandName == "Discounts.Delete" )
				{
					Guid gID = Sql.ToGuid(e.CommandArgument);
					SqlProcs.spDISCOUNTS_Delete(gID);
		...
		{
			SetPageTitle(L10n.Term("Discounts.LBL_LIST_FORM_TITLE"));
