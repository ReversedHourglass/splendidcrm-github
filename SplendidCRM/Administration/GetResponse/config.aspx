<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="config.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.GetResponse.Config" %>
<script runat="server">
/**********************************************************************************************************************
