<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="config.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.PayPalTransactions.Config" %>
<script runat="server">
/**********************************************************************************************************************
