<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.PayTrace.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<SplendidCRM:Shortcuts ID="ctlShortcuts" SubMenu="PayTrace" Runat="Server" />
</asp:Content>
