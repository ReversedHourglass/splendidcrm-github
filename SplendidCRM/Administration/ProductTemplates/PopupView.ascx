<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Administration.ProductTemplates.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeProductTemplate != null )
		{
			...
			window.opener.ChangeProductTemplate(sSelectedItems, '');
			window.close();
		}
		else
		{
