...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<!-- 11/23/2100 Paul.  Using an UpdatePanel will prevent HtmlInputFile from working.  One solution is to put the buttons in the Postback Trigger of the UpdatePanel. -->
