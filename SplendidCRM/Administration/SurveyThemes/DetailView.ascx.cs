	...
	public class DetailView : SplendidControl
	{
		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			try
			{
				...
				{
					SqlProcs.spSURVEY_THEMES_Delete(gID);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				// 11/12/2018 Paul.  Apply current stylesheet. 
				cssSurveyStylesheet.Attributes.Add("href" , "~/Surveys/stylesheet.aspx?ID=" + gID.ToString());
