...
<div id="divDetailView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Module="Teams" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />

	<%-- 03/08/2018 Paul.  Add support for PopupAudit. --%>
