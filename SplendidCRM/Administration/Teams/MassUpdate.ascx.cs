		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				if ( !IsPostBack )
				{
					...
					// 10/17/2020 Paul.  MassUpdate was re-displaying itself after being hidden. 
					this.Visible = !SplendidCRM.Crm.Config.enable_dynamic_mass_update() && SplendidCRM.Crm.Modules.MassUpdate(m_sMODULE) && !PrintView && (nACLACCESS_Delete >= 0);
				}
			}
			catch(Exception ex)
			{
