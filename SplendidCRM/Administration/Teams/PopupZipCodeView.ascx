<%@ Control CodeBehind="PopupZipCodeView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Administration.Teams.PopupZipCodeView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	<SplendidCRM:SearchView ID="ctlSearchView" Module="Teams" SearchMode="SearchPopupZipCode" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeTeam != null )
		{
			...
			window.opener.ChangeTeam(sSelectedItems, '');
			window.close();
		}
		else
		{
