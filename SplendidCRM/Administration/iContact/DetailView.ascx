<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Administration.iContact.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Module="iContact" Title="iContact.LBL_iContact_SETTINGS" EnableModuleLabel="false" EnablePrint="false" EnableHelp="true" Runat="Server" />
				...
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow ID="trInstructions">
						<asp:TableCell CssClass="dataLabel" VerticalAlign="top" ColumnSpan="4">
							<asp:Label Text='<%# L10n.Term("iContact.LBL_INSTRUCTIONS") %>' runat="server" />
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
