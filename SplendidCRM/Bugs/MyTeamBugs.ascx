<%@ Control CodeBehind="MyTeamBugs.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.MyTeamBugs" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divBugsMyBugs">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Bugs.LBL_LIST_MY_TEAM_BUGS" DivEditName="my_bugs_edit" Runat="Server" />
