...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divBugsThreads" Title="Threads.LBL_MODULE_NAME" Runat="Server" />

<div id="divBugsThreads" style='<%= "display:" + (CookieValue("divBugsThreads") != "1" ? "inline" : "none") %>'>
