<%@ Control CodeBehind="MyTeamCalls.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Calls.MyTeamCalls" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divCallsMyCalls">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Calls.LBL_LIST_MY_TEAM_CALLS" DivEditName="my_calls_edit" Runat="Server" />
