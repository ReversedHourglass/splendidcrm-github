...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divCasesThreads" Title="Threads.LBL_MODULE_NAME" Runat="Server" />

<div id="divCasesThreads" style='<%= "display:" + (CookieValue("divCasesThreads") != "1" ? "inline" : "none") %>'>
