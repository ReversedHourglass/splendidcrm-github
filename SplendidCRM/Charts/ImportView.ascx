<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportView.ascx.cs" Inherits="SplendidCRM.Charts.ImportView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divListView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Charts" Title=".moduleList.Home" EnablePrint="true" HelpName="index" EnableHelp="true" Runat="Server" />
		...
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table ID="tblMain" Width="100%" CellSpacing="4" CellPadding="0" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="15%" VerticalAlign="Top" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Charts.LBL_MODULE_NAME") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /></asp:TableCell>
						...
						<asp:TableCell Width="15%" VerticalAlign="Top" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Charts.LBL_CHART_NAME") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /></asp:TableCell>
						<asp:TableCell Width="35%" VerticalAlign="Top" CssClass="dataField">
					...
					<asp:TableRow>
						...
						<asp:TableCell VerticalAlign="Top" CssClass="dataField">
							<div style="DISPLAY: none">
								<asp:Label Text='<%# L10n.Term("Charts.LBL_CHART_TYPE") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" />
								<asp:DropDownList ID="lstCHART_TYPE" TabIndex="3" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" />
							</div>
