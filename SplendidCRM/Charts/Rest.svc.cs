...
namespace SplendidCRM.Charts
{
	...
	public class Rest
	{
		...
		[OperationContract]
		public Stream GetChartData(Stream input)
		{
			...
			RdlUtil.LocalLoadReportDefinition(Context, null, null, L10n, T10n, ds, sRDL, sMODULE, Guid.Empty, out sReportSQL, true, null);
