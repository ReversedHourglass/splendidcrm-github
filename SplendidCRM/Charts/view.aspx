<%@ Page language="c#" MasterPageFile="~/DetailView.Master" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Charts.View" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:DetailView ID="ctlDetailView" Visible='<%# SplendidCRM.Security.GetUserAccess("Charts", "view") >= 0 %>' Runat="Server" />
