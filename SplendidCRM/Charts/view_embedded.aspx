<%@ Page language="c#" Codebehind="view_embedded.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Charts.ViewEmbedded" %>
<script runat="server">
/**********************************************************************************************************************
...
window.onload = function()
{
	...
	{
		var ctlChartView_lblError = document.getElementById('<%# ctlChartView.ClientID %>_lblError');
		ctlChartView_lblError.innerHTML = e.message;
	}
}
</script>
</body>
