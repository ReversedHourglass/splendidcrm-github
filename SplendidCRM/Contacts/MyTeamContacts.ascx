<%@ Control CodeBehind="MyTeamContacts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.MyTeamContacts" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divContactsMyContacts">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Contacts.LBL_LIST_MY_TEAM_CONTACTS" DivEditName="my_contacts_edit" Runat="Server" />
