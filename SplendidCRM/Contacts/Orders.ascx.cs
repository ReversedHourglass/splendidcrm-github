	...
	public class Orders : SplendidControl
	{
		...
		protected void Page_Command(object sender, CommandEventArgs e)
		{
			try
			{
				...
				{
					// 05/06/2007 Paul.  Allow Order creation from contact. 
					case "Orders.Create":
					{
					...
					{
						Guid gORDER_ID = Sql.ToGuid(e.CommandArgument);
						SqlProcs.spORDERS_CONTACTS_Delete(gID, gORDER_ID);
		...
		protected void BindGrid()
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					if ( bDebug )
						RegisterClientScriptBlock("vwCONTACTS_ORDERS", Sql.ClientScriptBlock(cmd));
		...
		private void InitializeComponent()
		{
			...
			// 10/05/2017 Paul.  Add Archive relationship view. 
			m_sVIEW_NAME = "vwCONTACTS_ORDERS";
