<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contracts.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divContractsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divContractsActivitiesOpen" style='<%= "display:" + (CookieValue("divContractsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divContractsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divContractsActivitiesHistory" style='<%= "display:" + (CookieValue("divContractsActivitiesHistory") != "1" ? "inline" : "none") %>'>
