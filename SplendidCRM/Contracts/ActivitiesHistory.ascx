...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divContractsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Visible="false" Runat="Server" />

<div id="divContractsActivitiesOpen" visible="false" runat="server">
