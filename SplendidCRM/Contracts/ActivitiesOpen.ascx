...
<%-- 06/03/2015 Paul.  Combine ListHeader and DynamicButtons. --%>
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divContractsActivitiesHistory" Title="Activities.LBL_HISTORY" Visible="false" Runat="Server" />

<div id="divContractsActivitiesHistory" visible="false" runat="server">
