<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contracts.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divContractsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divContractsActivityStream" style='<%= "display:" + (CookieValue("divContractsActivityStream") != "1" ? "inline" : "none") %>'>
