...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Contacts" SubPanel="divContractsContacts" Title="Contacts.LBL_MODULE_NAME" Runat="Server" />

<div id="divContractsContacts" style='<%= "display:" + (CookieValue("divContractsContacts") != "1" ? "inline" : "none") %>'>
