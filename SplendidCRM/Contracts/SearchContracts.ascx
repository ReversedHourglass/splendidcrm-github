...
<SplendidCRM:SubPanelButtons Module="Contracts" SubPanel="divSearchContracts" ID="ctlListHeader" Title="Contracts.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchContracts" style='<%= "display:" + (CookieValue("divSearchContracts") != "1" ? "inline" : "none") %>'>
