<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.CreditCards.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<SplendidCRM:Shortcuts ID="ctlShortcuts" SubMenu="CreditCards" Runat="Server" />
</asp:Content>

<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="ListView" Src="ListView.ascx" %>
	<SplendidCRM:ListView ID="ctlListView" Visible='<%# SplendidCRM.Security.GetUserAccess("CreditCards", "list") >= 0 %>' Runat="Server" />
