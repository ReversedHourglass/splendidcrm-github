...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Quotes" SubPanel="divEmailsQuotes" Title="Quotes.LBL_MODULE_NAME" Runat="Server" />

<div id="divEmailsQuotes" style='<%= "display:" + (CookieValue("divEmailsQuotes") != "1" ? "inline" : "none") %>'>
