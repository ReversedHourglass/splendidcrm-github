...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divForumsThreads" Title="Threads.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divForumsThreads" style='<%= "display:" + (CookieValue("divForumsThreads") != "1" ? "inline" : "none") %>'>
