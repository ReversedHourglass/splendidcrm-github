...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divInvoicesActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divInvoicesActivitiesOpen" style='<%= "display:" + (CookieValue("divInvoicesActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divInvoicesActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divInvoicesActivitiesHistory" style='<%= "display:" + (CookieValue("divInvoicesActivitiesHistory") != "1" ? "inline" : "none") %>'>
