<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divInvoicesActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divInvoicesActivityStream" style='<%= "display:" + (CookieValue("divInvoicesActivityStream") != "1" ? "inline" : "none") %>'>
