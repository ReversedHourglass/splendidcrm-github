...
// 11/12/2011 Paul.  Provide a way to pass the Account to the Quotes popup. 
...
function QuotePopup()
{
	...
	var sACCOUNT_ID   = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_ID"  ).ClientID %>') != null ? document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_ID"  ).ClientID %>').value : '';
	var sACCOUNT_NAME = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_NAME").ClientID %>') != null ? document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_NAME").ClientID %>').value : '';
	return ModulePopup('Quotes', '<%= new SplendidCRM.DynamicControl(this, "QUOTE_ID").ClientID %>', '<%= new SplendidCRM.DynamicControl(this, "QUOTE_NAME").ClientID %>', 'ACCOUNT_NAME=' + escape(sACCOUNT_NAME), false, null);
}
function OrderPopup()
{
	// 02/29/2016 Paul.  Account fields will not exist in B2C mode. 
	var sACCOUNT_ID   = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_ID"  ).ClientID %>') != null ? document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_ID"  ).ClientID %>').value : '';
	var sACCOUNT_NAME = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_NAME").ClientID %>') != null ? document.getElementById('<%= new SplendidCRM.DynamicControl(this, "SHIPPING_ACCOUNT_NAME").ClientID %>').value : '';
	return ModulePopup('Orders', '<%= new SplendidCRM.DynamicControl(this, "ORDER_ID").ClientID %>', '<%= new SplendidCRM.DynamicControl(this, "ORDER_NAME").ClientID %>', 'ACCOUNT_NAME=' + escape(sACCOUNT_NAME), false, null);
}
</script>
...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="Invoices" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
