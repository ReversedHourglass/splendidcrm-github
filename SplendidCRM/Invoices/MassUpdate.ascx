...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divInvoicesMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<%-- 03/26/2018 Paul.  Hide mass update fields in ArchiveView. --%>
<div id="divInvoicesMassUpdate" style='<%= "display:" + (CookieValue("divInvoicesMassUpdate") != "1" && !ArchiveView() ? "inline" : "none") %>'>
