<%@ Control CodeBehind="MyInvoices.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.MyInvoices" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divInvoicesMyInvoices">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Invoices.LBL_LIST_MY_INVOICES" DivEditName="my_invoices_edit" Runat="Server" />
