...
namespace SplendidCRM.Invoices
{
	...
	public class NewRecord : NewRecordControl
	{
		...
		{
			get { return Sql.ToGuid(ViewState["ACCOUNT_ID"]); }
			set { ViewState["ACCOUNT_ID"] = value; }
		}
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			SqlProcs.spINVOICES_Update
				...
				, new DynamicControl(this, "SHIP_DATE"                       ).DateValue
			...
			//SqlProcs.spINVOICES_InsRelated(gID, sPARENT_TYPE, gPARENT_ID, trn);
		}
