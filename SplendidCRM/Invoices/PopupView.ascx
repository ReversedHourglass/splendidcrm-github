<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeInvoice != null )
		{
			...
			window.opener.ChangeInvoice(sSelectedItems, '');
			window.close();
		}
		else
		{
