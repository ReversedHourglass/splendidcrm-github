<%@ Control CodeBehind="SearchInvoices.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.SearchInvoices" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Invoices" SubPanel="divSearchInvoices" ID="ctlListHeader" Title="Invoices.LBL_LIST_FORM_TITLE" Runat="Server" />
	
<div id="divSearchInvoices" style='<%= "display:" + (CookieValue("divSearchInvoices") != "1" ? "inline" : "none") %>'>
