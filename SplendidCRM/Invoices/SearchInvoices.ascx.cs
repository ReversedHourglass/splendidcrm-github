...
{
	/// <summary>
	///		Summary description for SearchInvoices.
	/// </summary>
	public class SearchInvoices : SplendidControl
	{
			...
			if ( !Sql.IsEmptyString(sUnifiedSearch.Trim()) )
			{
				...
				using ( IDbConnection con = dbf.CreateConnection() )
				{
					...
					using ( IDbCommand cmd = con.CreateCommand() )
					{
						...
						if ( bDebug )
							RegisterClientScriptBlock("vwINVOICES_List", Sql.ClientScriptBlock(cmd));
