<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.Import" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ImportView ID="ctlImportView" Module="Invoices" Visible='<%# SplendidCRM.Security.GetUserAccess("Invoices", "import") >= 0 %>' Runat="Server" />
