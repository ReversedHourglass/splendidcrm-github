<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.KBDocuments.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divKBDocumentsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divKBDocumentsActivityStream" style='<%= "display:" + (CookieValue("divKBDocumentsActivityStream") != "1" ? "inline" : "none") %>'>
