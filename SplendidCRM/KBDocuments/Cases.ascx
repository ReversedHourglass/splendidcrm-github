<%@ Control CodeBehind="Cases.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.KBDocuments.Cases" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Cases" SubPanel="divKBDocumentsCases" Title="Cases.LBL_MODULE_NAME" Runat="Server" />

<div id="divKBDocumentsCases" style='<%= "display:" + (CookieValue("divKBDocumentsCases") != "1" ? "inline" : "none") %>'>
