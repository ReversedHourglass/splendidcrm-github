<%@ Control CodeBehind="MyTeamLeads.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.MyTeamLeads" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divLeadsMyLeads">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Leads.LBL_LIST_MY_TEAM_LEADS" DivEditName="my_leads_edit" Runat="Server" />
