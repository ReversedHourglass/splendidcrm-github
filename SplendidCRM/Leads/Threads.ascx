...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divLeadsThreads" Title="Threads.LBL_MODULE_NAME" Runat="Server" />

<div id="divLeadsThreads" style='<%= "display:" + (CookieValue("divLeadsThreads") != "1" ? "inline" : "none") %>'>
