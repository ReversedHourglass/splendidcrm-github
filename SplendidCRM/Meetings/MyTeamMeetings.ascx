<%@ Control CodeBehind="MyTeamMeetings.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Meetings.MyTeamMeetings" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divMeetingsMyMeetings">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Meetings.LBL_LIST_MY_TEAM_MEETINGS" DivEditName="my_meetings_edit" Runat="Server" />
