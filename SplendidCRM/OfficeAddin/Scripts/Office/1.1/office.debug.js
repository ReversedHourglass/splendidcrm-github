...
OSF._OfficeAppFactory = (function OSF__OfficeAppFactory() {
    ...
    var _retrieveHostInfo = function OSF__OfficeAppFactory$_retrieveHostInfo() {
		...
		// 05/27/2016 Paul.  The outlook-win32-16.00.js system does not work in Outlook 2016.  Instead, fallback to outlook-15.0.1.js
		if ( StartsWith(hostInfoValue, 'Outlook|Win32') )
			hostInfoValue = null;
        if(hostInfoValue) {
