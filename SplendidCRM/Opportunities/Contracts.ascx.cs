	...
	public class Contracts : SplendidControl
	{
				...
				switch ( e.CommandName )
				{
					...
					case "Contracts.Create":
						...
						if ( this.IsMobile || Sql.ToBoolean(Application["CONFIG.disable_editview_inline"]) )
							Response.Redirect("~/" + m_sMODULE + "/edit.aspx?OPPORTUNITY_ID=" + gID.ToString());
						else
						{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( !IsPostBack )
			{
				...
				// 06/03/2010 Paul.  Allow a contract to be created from an Opportunity. 
				ctlNewRecord.OPPORTUNITY_ID = gID;
			}
		}
		...
		private void InitializeComponent()
		{
			...
			// 10/05/2017 Paul.  Add Archive relationship view. 
			m_sVIEW_NAME = "vwOPPORTUNITIES_CONTRACTS";
