<%@ Control CodeBehind="MyTeamOpportunities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Opportunities.MyTeamOpportunities" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divOpportunitiesMyOpportunities">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Opportunities.LBL_MY_TEAM_TOP_OPPORTUNITIES" DivEditName="my_opportunities_edit" Runat="Server" />
