...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divOpportunitiesThreads" Title="Threads.LBL_MODULE_NAME" Runat="Server" />

<div id="divOpportunitiesThreads" style='<%= "display:" + (CookieValue("divOpportunitiesThreads") != "1" ? "inline" : "none") %>'>
