...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divOrdersActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divOrdersActivitiesOpen" style='<%= "display:" + (CookieValue("divOrdersActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divOrdersActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divOrdersActivitiesHistory" style='<%= "display:" + (CookieValue("divOrdersActivitiesHistory") != "1" ? "inline" : "none") %>'>
