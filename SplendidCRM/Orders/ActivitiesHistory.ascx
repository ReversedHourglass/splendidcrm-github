...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divOrdersActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Visible="false" Runat="Server" />

<div id="divOrdersActivitiesOpen" visible="false" runat="server">
