...
<%-- 06/03/2015 Paul.  Combine ListHeader and DynamicButtons. --%>
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divOrdersActivitiesHistory" Title="Activities.LBL_HISTORY" Visible="false" Runat="Server" />

<div id="divOrdersActivitiesHistory" visible="false" runat="server">
