<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Orders.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divOrdersActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divOrdersActivityStream" style='<%= "display:" + (CookieValue("divOrdersActivityStream") != "1" ? "inline" : "none") %>'>
