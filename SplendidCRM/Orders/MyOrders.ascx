<%@ Control CodeBehind="MyOrders.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Orders.MyOrders" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divOrdersMyOrders">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Orders.LBL_LIST_MY_ORDERS" DivEditName="my_orders_edit" Runat="Server" />
