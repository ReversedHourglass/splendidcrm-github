<%@ Control CodeBehind="SearchOrders.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Orders.SearchOrders" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Orders" SubPanel="divSearchOrders" ID="ctlListHeader" Title="Orders.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchOrders" style='<%= "display:" + (CookieValue("divSearchOrders") != "1" ? "inline" : "none") %>'>
