<%@ Control CodeBehind="SearchOrdersLineItems.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.OrdersLineItems.SearchLineItems" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="OrdersLineItems" SubPanel="divSearchOrdersLineItems" ID="ctlListHeader" Title="Line Item Search" Runat="Server" />

<div id="divSearchOrdersLineItems" style='<%= "display:" + (CookieValue("divSearchLeads") != "1" ? "inline" : "none") %>'>
