...
namespace SplendidCRM.Payments
{
	...
	public class ListView : SplendidControl
	{
								...
								using ( IDbTransaction trn = Sql.BeginTransaction(con) )
								{
									try
									{
										while ( stk.Count > 0 )
										{
											...
											SqlProcs.spPAYMENTS_MassUpdate(sIDs, ctlMassUpdate.ASSIGNED_USER_ID, T10n.ToServerTime(ctlMassUpdate.PAYMENT_DATE), ctlMassUpdate.PAYMENT_TYPE, ctlMassUpdate.PRIMARY_TEAM_ID, ctlMassUpdate.TEAM_SET_LIST, ctlMassUpdate.ADD_TEAM_SET, String.Empty, false, trn);
										}
										trn.Commit();
									}
									catch(Exception ex)
		...
		private void InitializeComponent()
		{
			...
			arrSelectFields.Add("PAYMENT_DATE");
