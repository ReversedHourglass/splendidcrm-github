<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Payments.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangePayment != null )
		{
			...
			window.opener.ChangePayment(sSelectedItems, '');
			window.close();
		}
		else
		{
