<%@ Control CodeBehind="SearchPayments.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Payments.SearchPayments" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Payments" SubPanel="divSearchPayments" ID="ctlListHeader" Title="Payments.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchPayments" style='<%= "display:" + (CookieValue("divSearchPayments") != "1" ? "inline" : "none") %>'>
