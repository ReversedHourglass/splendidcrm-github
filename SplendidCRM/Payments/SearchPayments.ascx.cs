...
{
	/// <summary>
	///		Summary description for SearchPayments.
	/// </summary>
	public class SearchPayments : SplendidControl
	{
			...
			if ( !Sql.IsEmptyString(sUnifiedSearch.Trim()) )
			{
				...
				using ( IDbConnection con = dbf.CreateConnection() )
				{
					...
					using ( IDbCommand cmd = con.CreateCommand() )
					{
						...
						if ( bDebug )
							RegisterClientScriptBlock("vwPAYMENTS_List", Sql.ClientScriptBlock(cmd));
