<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Products.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeProduct != null )
		{
			...
			window.opener.ChangeProduct(sSelectedItems, '');
			window.close();
		}
		else
		{
