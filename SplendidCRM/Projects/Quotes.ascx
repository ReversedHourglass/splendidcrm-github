...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Quotes" SubPanel="divProjectsQuotes" Title="Quotes.LBL_MODULE_NAME" Runat="Server" />

<div id="divProjectsQuotes" style='<%= "display:" + (CookieValue("divProjectsQuotes") != "1" ? "inline" : "none") %>'>
