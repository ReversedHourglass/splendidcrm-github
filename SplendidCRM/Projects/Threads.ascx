...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Threads" SubPanel="divProjectsThreads" Title="Threads.LBL_MODULE_NAME" Runat="Server" />

<div id="divProjectsThreads" style='<%= "display:" + (CookieValue("divProjectsThreads") != "1" ? "inline" : "none") %>'>
