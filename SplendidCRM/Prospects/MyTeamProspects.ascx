<%@ Control CodeBehind="MyTeamProspects.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Prospects.MyTeamProspects" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divProspectsMyProspects">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Prospects.LBL_LIST_MY_TEAM_PROSPECTS" DivEditName="my_prospects_edit" Runat="Server" />
