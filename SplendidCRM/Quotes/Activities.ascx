...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divQuotesActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divQuotesActivitiesOpen" style='<%= "display:" + (CookieValue("divQuotesActivitiesOpen") != "1" ? "inline" : "none") %>'>
