...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divQuotesActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Visible="false" Runat="Server" />

<div id="divQuotesActivitiesOpen" style='<%= "display:" + (CookieValue("divQuotesActivitiesOpen") != "1" ? "inline" : "none") %>' visible="false" runat="server">
...
<%-- 06/03/2015 Paul.  Combine ListHeader and DynamicButtons. --%>
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divQuotesActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divQuotesActivitiesHistory" style='<%= "display:" + (CookieValue("divQuotesActivitiesHistory") != "1" ? "inline" : "none") %>'>
