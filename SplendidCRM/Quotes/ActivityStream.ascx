<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Quotes.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divQuotesActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divQuotesActivityStream" style='<%= "display:" + (CookieValue("divQuotesActivityStream") != "1" ? "inline" : "none") %>'>
