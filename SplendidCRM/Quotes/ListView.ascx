...
<div id="divListView">
	...
	<SplendidCRM:HeaderButtons ID="ctlModuleHeader" Module="Quotes" Title=".moduleList.Home" EnablePrint="true" HelpName="index" EnableHelp="true" Runat="Server" />
	...
	<asp:Panel ID="pnlMassUpdateSeven" runat="server">
		...
		<SplendidCRM:DynamicMassUpdate ID="ctlDynamicMassUpdate" Module="Quotes" Visible="<%# SplendidCRM.Crm.Config.enable_dynamic_mass_update() && !PrintView && !IsMobile && SplendidCRM.Crm.Modules.MassUpdate(m_sMODULE) %>" runat="Server" />
	</asp:Panel>
