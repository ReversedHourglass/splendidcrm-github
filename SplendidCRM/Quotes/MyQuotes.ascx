<%@ Control CodeBehind="MyQuotes.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Quotes.MyQuotes" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divQuotesMyQuotes">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Quotes.LBL_LIST_MY_QUOTES" DivEditName="my_quotes_edit" Runat="Server" />
