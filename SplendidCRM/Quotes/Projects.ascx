...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Project" SubPanel="divQuotesProjects" Title="Project.LBL_PROJECT_SUBPANEL_TITLE" Runat="Server" />

<div id="divQuotesProjects" style='<%= "display:" + (CookieValue("divQuotesProjects") != "1" ? "inline" : "none") %>'>
