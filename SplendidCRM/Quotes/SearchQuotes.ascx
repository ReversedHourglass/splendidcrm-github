<%@ Control CodeBehind="SearchQuotes.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Quotes.SearchQuotes" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Quotes" SubPanel="divSearchQuotes" ID="ctlListHeader" Title="Quotes.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchQuotes" style='<%= "display:" + (CookieValue("divSearchQuotes") != "1" ? "inline" : "none") %>'>
