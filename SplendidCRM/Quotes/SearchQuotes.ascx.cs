...
{
	/// <summary>
	///		Summary description for SearchQuotes.
	/// </summary>
	public class SearchQuotes : SplendidControl
	{
			...
			if ( !Sql.IsEmptyString(sUnifiedSearch.Trim()) )
			{
				...
				using ( IDbConnection con = dbf.CreateConnection() )
				{
					...
					using ( IDbCommand cmd = con.CreateCommand() )
					{
						...
						if ( bDebug )
							RegisterClientScriptBlock("vwQUOTES_List", Sql.ClientScriptBlock(cmd));
