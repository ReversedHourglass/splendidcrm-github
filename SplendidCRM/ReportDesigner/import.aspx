<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.ReportDesigner.Import" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="ImportView" Src="~/Reports/ImportView.ascx" %>
	<SplendidCRM:ImportView ID="ctlImportView" Module="ReportDesigner" Visible='<%# SplendidCRM.Security.GetUserAccess("Reports", "import") >= 0 %>' Runat="Server" />
