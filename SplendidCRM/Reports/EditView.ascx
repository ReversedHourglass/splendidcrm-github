...
<asp:UpdatePanel UpdateMode="Conditional" runat="server">
		...
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table Width="100%" BorderWidth="0" CellSpacing="0" CellPadding="0" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Reports.LBL_REPORT_NAME") %>' runat="server" /></asp:TableCell>
	...
	<SplendidCRM:QueryBuilder ID="ctlQueryBuilder" UseSQLParameters="true" ShowRelated="true" Runat="Server" />
