<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.Reports.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divReportsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divReportsMassUpdate" style='<%= "display:" + (CookieValue("divReportsMassUpdate") != "1" ? "inline" : "none") %>'>
