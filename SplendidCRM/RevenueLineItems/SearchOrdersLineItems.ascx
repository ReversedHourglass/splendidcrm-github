<%@ Control CodeBehind="SearchRevenueLineItems.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.RevenueLineItems.SearchLineItems" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="RevenueLineItems" SubPanel="divSearchRevenueLineItems" ID="ctlListHeader" Title="Line Item Search" Runat="Server" />

<div id="divSearchRevenueLineItems" style='<%= "display:" + (CookieValue("divSearchLeads") != "1" ? "inline" : "none") %>'>
