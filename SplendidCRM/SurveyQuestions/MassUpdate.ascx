<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.SurveyQuestions.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divSurveyQuestionsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divSurveyQuestionsMassUpdate" style='<%= "display:" + (CookieValue("divSurveyQuestionsMassUpdate") != "1" ? "inline" : "none") %>'>
