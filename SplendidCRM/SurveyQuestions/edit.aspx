<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.SurveyQuestions.Edit" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:EditView ID="ctlEditView" Visible='<%# SplendidCRM.Security.GetUserAccess("SurveyQuestions", "edit") >= 0 %>' Runat="Server" />
