<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.SurveyQuestions.Import" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<SplendidCRM:Shortcuts ID="ctlShortcuts" SubMenu="SurveyQuestions" Runat="Server" />
</asp:Content>

<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="ImportView" Src="~/Import/ImportView.ascx" %>
	<SplendidCRM:ImportView ID="ctlImportView" Module="SurveyQuestions" Visible='<%# SplendidCRM.Security.GetUserAccess("SurveyQuestions", "import") >= 0 %>' Runat="Server" />
