<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Surveys.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divSurveysActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divSurveysActivityStream" style='<%= "display:" + (CookieValue("divSurveysActivityStream") != "1" ? "inline" : "none") %>'>
