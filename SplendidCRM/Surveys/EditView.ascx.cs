							...
							using ( IDbTransaction trn = Sql.BeginTransaction(con) )
							{
								try
								{
									SqlProcs.spSURVEYS_Update
										...
										, new DynamicControl(this, rowCurrent, "SURVEY_STYLE"      ).SelectedValue
										, new DynamicControl(this, rowCurrent, "PAGE_RANDOMIZATION").SelectedValue
										, new DynamicControl(this, rowCurrent, "SURVEY_THEME_ID"   ).ID
										...
										, new DynamicControl(this, rowCurrent, "LOOP_SURVEY"       ).Checked
										, new DynamicControl(this, rowCurrent, "EXIT_CODE"         ).Text
										, new DynamicControl(this, rowCurrent, "TIMEOUT"           ).IntegerValue
										// 09/30/2018 Paul.  Add survey record creation to survey. 
										, new DynamicControl(this, rowCurrent, "SURVEY_TARGET_MODULE").Text
										// 01/04/2019 Paul.  Add SURVEY_TARGET_ASSIGNMENT. 
										, new DynamicControl(this, rowCurrent, "SURVEY_TARGET_ASSIGNMENT").Text
										, trn
										);
			...
			try
			{
				...
				if ( !IsPostBack )
				{
					...
					else
					{
						...
						string sSURVEY_THEME_NAME = Crm.Modules.ItemName(Application, "SurveyThemes", gSURVEY_THEME_ID);
						new DynamicControl(this, "SURVEY_THEME_ID"  ).ID   = gSURVEY_THEME_ID  ;
						new DynamicControl(this, "SURVEY_THEME_NAME").Text = sSURVEY_THEME_NAME;
