...
namespace SplendidCRM.Surveys
{
	...
	public class MassUpdate : SplendidCRM.MassUpdate
	{
		...
		{
			get { return ctlTeamAssignedMassUpdate.PRIMARY_TEAM_ID; }
		}

		public string TEAM_SET_LIST
		{
			get { return ctlTeamAssignedMassUpdate.TEAM_SET_LIST; }
		}

		public bool ADD_TEAM_SET
		{
			get { return ctlTeamAssignedMassUpdate.ADD_TEAM_SET; }
		}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				if ( !IsPostBack )
				{
					...
					lstSTATUS.DataSource = SplendidCache.List("survey_status_dom");
					lstSTATUS.DataBind();
