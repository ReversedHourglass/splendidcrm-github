...
namespace SplendidCRM.Surveys
{
	...
	/// </summary>
	public class Run : SplendidPage
	{
		protected Guid   gID;
		protected string m_sMODULE;
		
		// 07/14/2013 Paul.  This page must be accessible without authentication. 
		...
		public Run()
		{
			this.PreInit += new EventHandler(Run_PreInit);
		}

		protected void Run_PreInit(object sender, EventArgs e)
		{
			this.Theme = "";
		}
