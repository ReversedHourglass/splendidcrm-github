<%@ Control CodeBehind="MyTeamTasks.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Tasks.MyTeamTasks" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divTasksMyTasks">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Tasks.LBL_LIST_MY_TEAM_TASKS" DivEditName="my_tasks_edit" Runat="Server" />
