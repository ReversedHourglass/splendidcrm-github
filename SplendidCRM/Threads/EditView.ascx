...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="Threads" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
