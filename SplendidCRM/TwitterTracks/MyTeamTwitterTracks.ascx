<%@ Control CodeBehind="MyTeamTwitterTracks.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.TwitterTracks.MyTeamTwitterTracks" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divTwitterTracksMyTwitterTracks">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="TwitterTracks.LBL_LIST_MY_TEAM_TWITTER_TRACKS" DivEditName="my_twittertracks_edit" Runat="Server" />
