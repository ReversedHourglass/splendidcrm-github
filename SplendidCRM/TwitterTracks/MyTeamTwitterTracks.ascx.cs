...
{
	/// <summary>
	///		Summary description for MyTeamTwitterTracks.
	/// </summary>
	public class MyTeamTwitterTracks : DashletControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				sUSER_TWITTER_TRACKS = SplendidCache.MyTwitterTracks();
				ScriptManager mgrAjax = ScriptManager.GetCurrent(this.Page);
				if ( !Sql.IsEmptyString(sUSER_TWITTER_TRACKS) )
