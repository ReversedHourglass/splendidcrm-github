<%@ Page language="c#" MasterPageFile="~/ListView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TwitterTracks.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ListView ID="ctlListView" Visible='<%# SplendidCRM.Security.GetUserAccess("TwitterTracks", "list") >= 0 %>' Runat="Server" />
