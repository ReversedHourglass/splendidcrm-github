<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" ValidateRequest="false" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TwitterTracks.Edit" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<SplendidCRM:Shortcuts ID="ctlShortcuts" SubMenu="TwitterTracks" Runat="Server" />
</asp:Content>

<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="EditView" Src="EditView.ascx" %>
	<SplendidCRM:EditView ID="ctlEditView" Visible='<%# SplendidCRM.Security.GetUserAccess("TwitterTracks", "edit") >= 0 %>' Runat="Server" />
