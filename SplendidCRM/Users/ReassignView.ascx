<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReassignView.ascx.cs" Inherits="SplendidCRM.Users.ReassignView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:ListHeader ID="ctlListHeader" Title="Users.LBL_REASS_SCRIPT_TITLE" Runat="Server" />
	<p></p>
	<asp:UpdatePanel UpdateMode="Conditional" runat="server">
		<ContentTemplate>
			...
			<asp:Panel ID="pnlSelectUser" runat="server">
				<asp:Label Text='<%# L10n.Term("Users.LBL_REASS_DESC_PART1") %>' Runat="server" />
				<br />
				<br />
				<asp:Table SkinID="tabFrame" runat="server">
					<asp:TableRow>
						<asp:TableCell>
							<asp:Label Text='<%# L10n.Term("Users.LBL_REASS_SELECT_USER") %>' Runat="server" /><br />
							<asp:Table SkinID="tabEditView" CellPadding="6" runat="server">
								...
								<asp:TableRow>
									<asp:TableCell>
										...
										<asp:DropDownList ID="lstTO"      DataValueField="ID"          DataTextField="USER_NAME"    runat="server" />
									</asp:TableCell>
								</asp:TableRow>
								...
								<asp:TableRow>
									<asp:TableCell>
										...
										<asp:ListBox      ID="lstMODULES" DataValueField="MODULE_NAME" DataTextField="MODULE_NAME" Rows="6" SelectionMode="Multiple" OnSelectedIndexChanged="lstMODULES_Changed" AutoPostBack="true" runat="server" />
									</asp:TableCell>
								</asp:TableRow>
