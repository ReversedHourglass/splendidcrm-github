...
namespace SplendidCRM
{
	...
	public class AuthorizeNetUtils
	{
		...
		private static void StandardThrowError(ANetApiResponse result, string sResult)
		{
		...
		private static string CleanseData(string sValue, int nMaxLength)
		{
			return Sql.MaxLength(CleanseData(sValue), nMaxLength);
		}

		public static string ValidateLogin(HttpApplicationState Application, string sUserName, string sTransactionKey, bool bTestMode)
		{
		...
		public static string Refund(HttpApplicationState Application, string sTransactionID)
		{
			Guid gCREDIT_CARD_KEY = Sql.ToGuid(Application["CONFIG.CreditCardKey"]);
			Guid gCREDIT_CARD_IV  = Sql.ToGuid(Application["CONFIG.CreditCardIV" ]);
		...
		public static DataTable Transactions(HttpApplicationState Application, DateTime dtStartDate, DateTime dtEndDate)
		{
			Guid gCREDIT_CARD_KEY = Sql.ToGuid(Application["CONFIG.CreditCardKey"]);
			Guid gCREDIT_CARD_IV  = Sql.ToGuid(Application["CONFIG.CreditCardIV" ]);
		...
		private static DataSet CreateCustomerProfileDataSet()
		{
			DataSet ds = new DataSet();
		...
		private static void SetCustomerProfile(DataSet ds, getCustomerProfileResponse resultTransactionList)
		{
		...
		public static DataSet CustomerProfile(HttpApplicationState Application, string sCustomerProfileId)
		{
			Guid gCREDIT_CARD_KEY = Sql.ToGuid(Application["CONFIG.CreditCardKey"]);
			Guid gCREDIT_CARD_IV  = Sql.ToGuid(Application["CONFIG.CreditCardIV" ]);
		...
		public static DataSet CustomerProfiles(HttpApplicationState Application)
		{
			Guid gCREDIT_CARD_KEY = Sql.ToGuid(Application["CONFIG.CreditCardKey"]);
			Guid gCREDIT_CARD_IV  = Sql.ToGuid(Application["CONFIG.CreditCardIV" ]);
