...
namespace SplendidCRM.SplendidCharge
{
	public class CC
	{
		public static string Charge(HttpApplicationState Application, Guid gID, Guid gCURRENCY_ID, Guid gACCOUNT_ID, Guid gCREDIT_CARD_ID, string sClientIP, string sOrderID, string sDESCRIPTION, Decimal dAMOUNT)
		{
			...
			return Charge(Application, gID, gCURRENCY_ID, gACCOUNT_ID, gCREDIT_CARD_ID, sClientIP, sOrderID, sDESCRIPTION, "Sale", dAMOUNT, String.Empty, sPaymentGateway, sPaymentGateway_Login, sPaymentGateway_Password, bPaymentGateway_TestMode);
		}

		public static string Charge(HttpApplicationState Application, Guid gID, Guid gCURRENCY_ID, Guid gACCOUNT_ID, Guid gCREDIT_CARD_ID, string sClientIP, string sOrderID, string sDESCRIPTION, string sTransactionType, Decimal dAMOUNT, string sTransactionID, string sPaymentGateway, string sPaymentGateway_Login, string sPaymentGateway_Password, bool bPaymentGateway_TestMode)
		{
			...
			{
				return SplendidCRM.SplendidCharge.DotNetCharge.CC.Charge(Application, gID, gCURRENCY_ID, gACCOUNT_ID, gCREDIT_CARD_ID, sClientIP, sOrderID, sDESCRIPTION, sTransactionType, dAMOUNT, sTransactionID, sPaymentGateway, sPaymentGateway_Login, sPaymentGateway_Password, bPaymentGateway_TestMode);
			}
			else if ( sLibrary == "nsoftware.InPayWeb" )
			{
				...
				//	return SplendidCRM.SplendidCharge.NSoftware.Echeck.eCheck(Application, gID, gCURRENCY_ID, gACCOUNT_ID, gCREDIT_CARD_ID, sClientIP, sOrderID, sDESCRIPTION, sTransactionType, dAMOUNT, sTransactionID, sPaymentGateway, sPaymentGateway_Login, sPaymentGateway_Password, bPaymentGateway_TestMode);
				//else
					return SplendidCRM.SplendidCharge.NSoftware.Icharge.Charge(Application, gID, gCURRENCY_ID, gACCOUNT_ID, gCREDIT_CARD_ID, sClientIP, sOrderID, sDESCRIPTION, sTransactionType, dAMOUNT, sTransactionID, sPaymentGateway, sPaymentGateway_Login, sPaymentGateway_Password, bPaymentGateway_TestMode);
			}
...
namespace SplendidCRM.SplendidCharge.NSoftware
{
	...
	public class Recurringbilling : LateLoadObject
	{
		...
		public static void StoreCreditCard(HttpApplicationState Application, ref string sCARD_TOKEN, string sNAME, string sCARD_TYPE, string sCARD_NUMBER, string sSECURITY_CODE, string sBANK_NAME, string sBANK_ROUTING_NUMBER, int nEXPIRATION_MONTH, int nEXPIRATION_YEAR, string sADDRESS_STREET, string sADDRESS_CITY, string sADDRESS_STATE, string sADDRESS_POSTALCODE, string sADDRESS_COUNTRY, string sEMAIL, string sPHONE, string sPaymentGateway, string sPaymentGateway_Login, string sPaymentGateway_Password, bool bPaymentGateway_TestMode)
		{
			...
			Recurringbilling oRecurring = new Recurringbilling();
	...
	public class Echeck : LateLoadObject
	{
		...
		public static string eCheck(HttpApplicationState Application, Guid gID, Guid gCURRENCY_ID, Guid gACCOUNT_ID, Guid gCREDIT_CARD_ID, string sClientIP, string sOrderID, string sDESCRIPTION, string sTransactionType, Decimal dAMOUNT, string sTransactionID, string sPaymentGateway, string sPaymentGateway_Login, string sPaymentGateway_Password, bool bPaymentGateway_TestMode)
		{
			Guid gCREDIT_CARD_KEY = Sql.ToGuid(Application["CONFIG.CreditCardKey"]);
			Guid gCREDIT_CARD_IV  = Sql.ToGuid(Application["CONFIG.CreditCardIV" ]);
...
namespace SplendidCRM.SplendidCharge.DotNetCharge
{
	...
	public class CC
	{
		...
		public string            Application              { get { return _GetValue("Application"              , m_sApplication              ); } set { _SetValue("Application"              , value, ref m_sApplication              ); } }
		...
		*/
		...
		public static string Refund(HttpApplicationState Application, Guid gID, Guid gCURRENCY_ID, Guid gACCOUNT_ID, Guid gCREDIT_CARD_ID, string sClientIP, string sOrderID, string sDESCRIPTION, Decimal dAMOUNT, string sTransactionID)
		{
			string sPaymentGateway          = Sql.ToString (Application["CONFIG.PaymentGateway"         ]);
			string sPaymentGateway_Login    = Sql.ToString (Application["CONFIG.PaymentGateway_Login"   ]);
			string sPaymentGateway_Password = Sql.ToString (Application["CONFIG.PaymentGateway_Password"]);
			bool   bPaymentGateway_TestMode = Sql.ToBoolean(Application["CONFIG.PaymentGateway_TestMode"]);
			return Charge(Application, gID, gCURRENCY_ID, gACCOUNT_ID, gCREDIT_CARD_ID, sClientIP, sOrderID, sDESCRIPTION, "Refund", dAMOUNT, sTransactionID, sPaymentGateway, sPaymentGateway_Login, sPaymentGateway_Password, bPaymentGateway_TestMode);
		}
		*/
		...
		public static string Charge(HttpApplicationState Application, Guid gID, Guid gCURRENCY_ID, Guid gACCOUNT_ID, Guid gCREDIT_CARD_ID, string sClientIP, string sOrderID, string sDESCRIPTION, string sTransactionType, Decimal dAMOUNT, string sTransactionID, string sPaymentGateway, string sPaymentGateway_Login, string sPaymentGateway_Password, bool bPaymentGateway_TestMode)
		{
			...
			SplendidCRM.SplendidCharge.DotNetCharge.CC oCharge = new SplendidCRM.SplendidCharge.DotNetCharge.CC();
			...
			// Transaction Details
			oCharge.Application   = "SplendidCRM";
