...
namespace SplendidCRM
{
	public class SplendidMailGmail : SplendidMailClient
	{
		...
		override public void Send(MailMessage mail)
		{
			...
			Google.Apis.Services.BaseClientService.Initializer initializer = SplendidCRM.GoogleApps.GetUserCredentialInitializer(Application, USER_ID, GmailService.Scope.GmailSend);
