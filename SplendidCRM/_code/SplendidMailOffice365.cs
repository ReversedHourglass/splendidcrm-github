...
namespace SplendidCRM
{
	public class SplendidMailOffice365 : SplendidMailClient
	{
		...
		public SplendidMailOffice365(HttpApplicationState Application, Guid gOAUTH_TOKEN_ID)
		{
			...
			this.token       = SplendidCRM.ActiveDirectory.Office365RefreshAccessToken(Application, sOAuthDirectoryTenatID, sOAuthClientID, sOAuthClientSecret, gOAUTH_TOKEN_ID, false);
		}

		override public void Send(System.Net.Mail.MailMessage mail)
		{
			Spring.Social.Office365.Api.IOffice365 service = Office365Sync.CreateApi(this.Application, this.token.access_token);
