...
namespace Spring.Social.ConstantContact
{
	public class Contact : HObject
	{
		...
		public Contact(Spring.Social.ConstantContact.Api.IConstantContact constantContact) : base(constantContact, "Contacts", "Name", "Contacts", "CONTACTS", "NAME", true)
		{
		}

		public Contact(Spring.Social.ConstantContact.Api.IConstantContact constantContact, string siContactTableName, string siContactTableSort, string sCRMModuleName, string sCRMTableName, string sCRMTableSort, bool bCRMAssignedUser)
			 : base(constantContact, siContactTableName, siContactTableSort, sCRMModuleName, sCRMTableName, sCRMTableSort, bCRMAssignedUser)
		{
		}
