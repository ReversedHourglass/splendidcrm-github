...
namespace Spring.Social.ConstantContact
{
	...
	{
		public Lead(Spring.Social.ConstantContact.Api.IConstantContact constantContact) : base(constantContact, "Contacts", "Name", "Leads", "LEADS", "NAME", true)
		{
		}
		...
		{
			bool bChanged = base.BuildUpdateProcedure(Application, Session, spUpdate, row, gUSER_ID, gTEAM_ID, gASSIGNED_USER_ID, trn, sbChanges);
