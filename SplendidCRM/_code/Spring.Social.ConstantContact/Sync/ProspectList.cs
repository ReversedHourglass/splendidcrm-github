...
namespace Spring.Social.ConstantContact
{
	public class ProspectList : HObject
	{
		...
		public ProspectList(Spring.Social.ConstantContact.Api.IConstantContact constantContact) : base(constantContact, "Lists", "Name", "ProspectList", "PROSPECT_LISTS", "NAME", false)
		{
		}
