...
namespace Spring.Social.Marketo
{
	public class Contact : MObject
	{
		...
		public Contact(Spring.Social.Marketo.Api.IMarketo marketo, string fields) : base(marketo, "Contacts", "Name", "Contacts", "CONTACTS", "NAME", true, fields)
		{
		}

		public Contact(Spring.Social.Marketo.Api.IMarketo marketo, string fields, string sMarketoTableName, string sMarketoTableSort, string sCRMModuleName, string sCRMTableName, string sCRMTableSort, bool bCRMAssignedUser)
			: base(marketo, sMarketoTableName, sMarketoTableSort, sCRMModuleName, sCRMTableName, sCRMTableSort, bCRMAssignedUser, fields)
		{
		}
		...
		public static Guid GetAccountID(HttpApplicationState Application, string sNAME)
		{
		...
		public override bool BuildUpdateProcedure(HttpApplicationState Application, ExchangeSession Session, IDbCommand spUpdate, DataRow row, Guid gUSER_ID, Guid gTEAM_ID, Guid gASSIGNED_USER_ID, IDbTransaction trn, StringBuilder sbChanges)
		{
			bool bChanged = this.InitUpdateProcedure(spUpdate, row, gUSER_ID, gTEAM_ID);
			
			Guid gACCOUNT_ID = GetAccountID(Application, this.company);
